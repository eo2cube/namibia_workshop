...
# as the original function from DEA only modified for the usage in the JMU Wuerzburgs environment
# i.e. not using the collection naming
def s2_indices(ds,
                      index=None,
                      custom_varname=None,
                      normalise=True,
    ...
    index_dict = {
                  ...
                  # Normalised Difference Vegation Index using narrow_nir, i.e. band 8a, Rouse 1973
                  'nNDVI': lambda ds: (ds.narrow_nir - ds.red) /
